...
const filteredgames = videogames.filter((videogame) =>
  videogame.genders.filter((gender) => gender.toLowerCase == "rpg")
);

const mediaScores = filteredgames.reduce(function (accumulador, juego) {
  return (accumulador + juego.score) / 2;
}, 0);
